"""
Search for high-debt coefficient closer to -3.5.
"""
...
def main():
    ...
    print("\n" + "="*90)
    print("SEARCH: Looking for high-debt coefficient closer to -3.5")
    print("="*90)
    
    results = []
    
    # Try different sample periods
    for start_str in ['2008-09', '2008-10', '2008-11', '2008-12', '2009-01', '2009-02', '2009-03', '2009-04', '2009-05', '2009-06']:
        for end_str in ['2013-06', '2013-09', '2013-12', '2014-03', '2014-06', '2014-09', '2014-12', '2015-03']:
            start = pd.Timestamp(start_str + '-01')
            end = pd.Timestamp(end_str + '-01')
            
            for thresh in np.arange(0.155, 0.170, 0.002):
                for scale in np.arange(2, 8, 0.5):
    ...
    if results:
        ...
        print(f"  Total error: {best['coef_err']:.1f}")
